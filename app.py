...
ensemble_model, scaler,cnn_model = load_model_and_scaler()
def ensemble_pg():
    # Streamlit app title
    ...
    # Wrapping inputs in styled containers
...
pg = st.navigation([
    st.Page(cnn_pg, title="CNN Model", icon=":material/favorite:"),
    st.Page(ensemble_pg, title="Ensemble Model", icon=":material/favorite:"),
])
pg.run()
